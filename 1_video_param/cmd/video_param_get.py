...
def apply_file (file_name,num,row_x):
        ...
        # # snd_dev id 
        # t_snd_id=search_row_id(rows[0],'snd_device_id_2')-1
        # print('t_snd_id',t_snd_id)
        # result_x[t_snd_id]=cut_word(result_x[t_snd_id],search_snd_dev)
        # # print(result_x[t_snd_id])

        # # # acdb id 
        # t_acdb_id=search_row_id(rows[0],'acdb_id')-1
        # print('t_acdb_id',t_acdb_id)
        # result_x[t_acdb_id]=cut_word(result_x[t_acdb_id],search_acdb)

        # # set output param -- audio-device
        # t_param_id=search_row_id(rows[0],'set_p_snddev_parameters')-1
        # print('t_param_id',t_param_id)
        # result_x[t_param_id]=cut_word(result_x[t_param_id],search_audio_dev)

        # # source
        # t_source_id=search_row_id(rows[0],'c_source')-1
        # print('t_source_id',t_source_id)
        # result_x[t_source_id]=cut_word(result_x[t_source_id],search_source_id)

        # # input audio_device
        # t_audio_device_id=search_row_id(rows[0],'c_audio_device')-1
        # print('t_audio_device_id',t_audio_device_id)
        # result_x[t_audio_device_id]=cut_word(result_x[t_audio_device_id],search_audio_dev)

        # # acdb copp apptype
        # t_apptype=search_row_id(rows[0],'app_id')-1
        # print('t_apptype',t_apptype)
        # result_x[t_apptype]=cut_word(result_x[t_apptype],search_app_type)
        ...
        with open("result_video_param.csv","a+", newline='\n') as csvfile: 
...
# get key word
with open('lib/key_word_omx.csv','r') as csvfile:
...
with open("result_video_param.csv","w", newline='\n') as csvfile: 
    writer = csv.writer(csvfile)
